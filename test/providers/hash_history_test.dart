...
main() {
  group('HashHistory', () {
    ...
    group('go', () {
      ...
      test('should use location.assign/.replace when useFragment=true', () async {
    ...
    group('goBack', () {
      test('should go to the previous route', () async {
        ...
        Router router = new Router(historyProvider: new HashHistory(windowImpl: mockWindow));
    ...
    group('url', () {
      test('should reconstruct url', () async {
        ...
        final router = new Router(historyProvider: new HashHistory(windowImpl: mockWindow));
        router.root
          ..addRoute(
              name: 'a',
              defaultRoute: true,
